...
public class AmbienteLadoRio extends Ambiente {

    //construtor
    public AmbienteLadoRio(String nome, String descricao, Double dificuldadeExploracao, double probabilidadeEventos, String condicoesClimaticas, List<Item> recursosDisponiveis){
