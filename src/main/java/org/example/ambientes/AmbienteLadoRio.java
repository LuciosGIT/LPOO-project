...
public class AmbienteLadoRio extends Ambiente {
    ...
    //construtor
    public AmbienteLadoRio(String nome, String descricao, int dificuldadeExploracao, double probabilidadeEventos, String condicoesClimaticas, List<Item> recursosDisponiveis){
