...
public class AmbienteRuinas extends Ambiente {
    ...
    //construtor
    public AmbienteRuinas(String nome, String descricao, Double dificuldadeExploracao, double probabilidadeEventos, List<TipoClimatico> condicoesClimaticas, Boolean estruturasInstaveis){
